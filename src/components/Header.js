...
const Hearder = () => {
  ...
  const menuItems = ["Our story", "Membership", "Write", "Sign in"];
    ...
    <div className="border-b-2 border-black">
      <div className="px-6 py-6">
        <div className="w-full flex justify-between">
          <div className="w-44">
            <svg viewBox="0 0 3940 610" class="bs q">
          ...
          <div className="h-full flex items-center">
            <ul className="sm:flex hidden items-center mr-2 text-sm">
              {menuItems.map((item) => (
            ...
            <div class="sm:hidden">
              <button
                class="navbar-burger flex items-center text-blue-600 p-1"
            ...
            {isToggled && (
              <div className="absolute top-0 left-0 h-full w-full bg-white">
                <div className="flex w-full justify-between px-4">
                  ...
                  <button
                    class="navbar-close w-1/4 flex mt-6 justify-end mr-4"
                    onClick={() => setIsToggled(!isToggled)}
                  >
                    <svg
                ...
                <div className=" my-8">
                  {menuItems.map((item) => (
                    <h3 className="py-2 px-4 text-black font-medium">{item}</h3>
                  ))}
                </div>
              </div>
            )}
